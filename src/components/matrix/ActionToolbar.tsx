...
import { useStore } from '../../store'; // <--- WICHTIG: Store Connection
import { 
  UserPlus, Plus, FolderPlus, Filter, Trash2, X 
} from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import clsx from 'clsx';

interface Props {
  // Diese Toolbar braucht nur noch Infos über den Filter-Status vom Parent
...
export function ActionToolbar({ activeGroupId, onToggleFilter }: Props) {
  ...
  // Wir holen uns die Daten und Actions direkt hier
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    activeGroupId === g.id
                      ...
                      : "bg-indigo-50 text-indigo-700 border-indigo-100 hover:border-indigo-300 hover:bg-indigo-100"
                  )}
                >
                  {g.name}
                </button>
